// ==UserScript==
// @name        Saved search open auctions only in osta.ee
// @namespace   Violentmonkey Scripts
// @match       https://www.osta.ee/index.php?fuseaction=search.agents*
// @grant       none
// @version     1.0
// @author      Cougar
// @license     MIT
// @homepageURL https://github.com/Cougar/userscripts
// @downloadURL https://github.com/Cougar/userscripts/blob/main/osta-ee-search-links.user.js
// @description Modify search agent list links to filter only auctions
...
(function (doc) {
  ...
  function changeURLs() {
    var ids = doc.querySelectorAll('td a');
    Array.prototype.forEach.call(ids, function(el, i) {
      let urlObj = new URL(el.href);
      paramsToRemove.forEach(param => urlObj.searchParams.delete(param));
      urlObj.searchParams.append("q[exclude_cat][]", "1530");
      urlObj.searchParams.append("q[exclude_cat][]", "1191");
      urlObj.searchParams.set("pagesize", "180");
      el.href = urlObj.pathname + (urlObj.search ? '?' + urlObj.searchParams.toString() : '');
    });
  }
